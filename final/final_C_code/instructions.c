...
static List *createInstructions(Maze maze, List *roads, State state, Location *location, const int number_of_destinations)
{
    ...
    for (int x = 0; x < number_of_destinations; ++x) {
        ...
        for (char score = road->map[instruction.location.i][instruction.location.j] - 1; score > 0; --score) {
            ...
            case (FORWARD_NORTH):
                if (instruction.location.i > 0 && road->map[instruction.location.i - 1][instruction.location.j] == score) {
                    instruction.location.i--;
                    instruction.code = RECHTDOOR;
                } else if (instruction.location.j < 10 && road->map[instruction.location.i][instruction.location.j + 1] == score) {
                ...
                } else if (instruction.location.j > 0 && road->map[instruction.location.i][instruction.location.j - 1] == score) {
                    instruction.location.j--;
                ...
                break;
            case (FORWARD_EAST):
                if (instruction.location.j < 10 && road->map[instruction.location.i][instruction.location.j + 1] == score) {
                    instruction.location.j++;
                    instruction.code = RECHTDOOR;
                } else if (instruction.location.i < 10 && road->map[instruction.location.i + 1][instruction.location.j] == score) {
                    instruction.location.i++;
                    ...
                    if (maze.mines_possible[instruction.location.i][instruction.location.j] == true || (road->map[instruction.location.i][instruction.location.j] == 1 && x != number_of_destinations - 1))
                        ...
                        instruction.code = RECHTSAF;
                } else if (instruction.location.i > 0 && road->map[instruction.location.i - 1][instruction.location.j] == score) {
                    instruction.location.i--;
                ...
                break;
            case (FORWARD_SOUTH):
                if (instruction.location.i < 10 && road->map[instruction.location.i + 1][instruction.location.j] == score) {
                    instruction.location.i++;
                    instruction.code = RECHTDOOR;
                } else if (instruction.location.j > 0 && road->map[instruction.location.i][instruction.location.j - 1] == score) {
                    instruction.location.j--;
                ...
                break;
            case (FORWARD_WEST):
                if (instruction.location.j > 0 && road->map[instruction.location.i][instruction.location.j - 1] == score) {
                    instruction.location.j--;
                    instruction.code = RECHTDOOR;
                } else if (instruction.location.i > 0 && road->map[instruction.location.i - 1][instruction.location.j] == score) {
                    instruction.location.i--;
